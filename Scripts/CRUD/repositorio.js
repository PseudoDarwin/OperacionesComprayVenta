...
async function AgregarArchivo() {
    ...
    urlencoded.append('materia', document.getElementById("dropMateriaagregar").value) //i
    urlencoded.append('carrera', document.getElementById("dropCarreraagregar").value); //i 
    urlencoded.append('autor', document.getElementById("txtAutoragregar").value); //
    urlencoded.append('tipo', document.getElementById("dropTipoagregar").value); //
...
async function EditarArchivo() {
    ...
    urlencoded.append('materia', document.getElementById("dropMateriaeditar").value) //i
    urlencoded.append('carrera', document.getElementById("dropCarreraeditar").value); //i 
    urlencoded.append('autor', document.getElementById("txtautoreditar").value); //
    urlencoded.append('tipo', document.getElementById("dropTipoeditar").value); //
